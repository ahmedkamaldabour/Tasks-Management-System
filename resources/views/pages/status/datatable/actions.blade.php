<a href="{{route('status.edit',$status)}}" class="btn btn-primary mr-2" data-toggle="tooltip"
...
{{--<form id="delete" action="{{route('status.destroy',$status)}}" method="post" class="d-inline-block">--}}
{{--    @csrf--}}
{{--    @method('DELETE')--}}
