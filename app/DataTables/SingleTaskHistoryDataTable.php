...
class SingleTaskHistoryDataTable extends DataTable
{
    /**
    ...
    public function query(TaskHistory $model): QueryBuilder
    {
        return $model->newQuery()->with(['task:id,title', 'user:id,name', 'phase_old_value:id,name',
            ...
            'assigned_new_value:id,name'])->where('task_id', $this->id);
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            ['data' => 'old_value', 'name' => 'old_value.name', 'title' => __('tasks-history.old_value')],
            ['data' => 'new_value', 'name' => 'new_value.name', 'title' => __('tasks-history.new_value')],
